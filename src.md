...
Iran's telecommunications industry is almost entirely state-owned, dominated by the Telecommunication Company of Iran (TCI). As of 2020, 4G LTE population coverage in Iran has reached around 90%.  As of 2013, 90% of all of Internet traffic is being routed to hosts outside the country

Social Media Platforms, Messengers:
Instagram: 23 million downloads.
Telegram (fork): 13 million users ++ 
